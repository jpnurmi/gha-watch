...
function bindEvents(): void {
  ...
  on("click", '[data-action="open-github-url"]', async (event, button: HTMLButtonElement) => {
    event.preventDefault();
  ...
  on("click", '[data-action="open-repo-ci-workflow"]', async (event, button: HTMLButtonElement) => {
    event.preventDefault();
    event.stopPropagation();
